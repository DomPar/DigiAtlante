...
const Api = () => {
  ...
  return (
    <div id="dexDisplay" className="overflow-y-auto h-full w-[70vw] m-auto" >
      <h1 className='text-center py-3 text-2xl mt-16 text-with-border'>Endpoints</h1>
      <div className='flex flex-col sm:flex-row flex-wrap w-full h-4/6 justify-evenly gap-4'>
        <div className='h-[150px] w-full sm:w-[500px] p-4  bg-black bg-opacity-70 py-6 shadow-2xl rounded-xl'>
            <h3 className='text-center text-with-border'>Get all digimons:</h3>
            <p>api/digimon</p>
        </div>
        <div className='h-[150px] w-full sm:w-[500px] p-4  bg-black bg-opacity-70 py-6 shadow-2xl rounded-xl'>
