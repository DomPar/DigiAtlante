...
const Welcome = () => {
  ...
  return (
    <main id='containerWelcome' className='flex flex-col items-center m-auto bg-black bg-opacity-50 w-[70%] h-[90%]'>
        <div className='w-[90%] h-[90%] flex flex-col items-center'>
          <img src="\image\titulo.png" alt="titulo" className='h-[20%] w-[70%]'/>
          <div className='h-[80%] grid grid-cols-12 grid-rows-12'>
            ...
            <div className='flex  justify-center items-center gap-6 row-start-3 row-end-6 col-start-7 col-end-12'>
            ...
            <div className='flex gap-6 row-start-8 row-end-12 col-start-7 col-end-12 flex-col  justify-center '>
              <p>Changelog</p>
