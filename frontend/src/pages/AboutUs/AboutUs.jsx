...
const cvDomi = () => {
  ...
  return (
    <div id="containerAbout" className='flex flex-col items-center justify-start pt-24 h-full w-[70vw] m-auto' style={{ background: 'linear-gradient(to bottom, rgba(176, 220, 232, 0.5), rgba(185, 207, 129, 0.5))' }}>
